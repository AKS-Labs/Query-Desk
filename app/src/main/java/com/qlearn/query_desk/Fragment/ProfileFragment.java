...
import com.qlearn.query_desk.Adapter.FollowersAdapter;
import com.qlearn.query_desk.Model.Follow;
import com.qlearn.query_desk.R;
import com.qlearn.query_desk.User;
import com.qlearn.query_desk.databinding.FragmentProfileBinding;
        ...
        database.getReference().child("Users").child(auth.getUid())
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    binding.textView12.setText(user.getFollowersCount()+ "");
...
//        ImageView editCoverImg = findViewById(R.id.editCoverImg);

        binding.editCoverImg.setOnClickListener(new View.OnClickListener() {
            @Override
